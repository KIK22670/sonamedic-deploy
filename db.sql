...
CREATE TABLE IF NOT EXISTS reintonaudiometrie (
  ...
  rt_test_id BIGINT NOT NULL, 
  rt_datum DATE NOT NULL,  
  rt_startzeit TIMESTAMP NOT NULL,  
  rt_endzeit TIMESTAMP NOT NULL,  
  rt_p_id INT NOT NULL REFERENCES p_patienten(p_id) ON DELETE CASCADE,  
  rt_frequenz INT NOT NULL,  
  rt_ohr VARCHAR(10) NOT NULL,  
  rt_lautstaerke_db DECIMAL(5,2) NOT NULL,  
  rt_gehoert BOOLEAN NOT NULL  
);
