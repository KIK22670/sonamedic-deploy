async function loadAppointments() {
    try {
        ...
        pastAppointments.forEach(appointment => {
            ...
            const appointmentType = getTermintypBezeichnung(appointment.t_termintyp);
...
// Funktion zum Konvertieren von Termintyp-ID in Bezeichnung
function getTermintypBezeichnung(termintypId) {
    switch (termintypId) {
        case 1:
        ...
        default:
            return 'Unbekannter Termintyp';  // Falls der Typ nicht bekannt ist
    }
}
