...
CREATE TABLE IF NOT EXISTS p_patient (
  ...
  p_u_id INT NOT NULL,
  CONSTRAINT fk_p_patient_u_userverwaltung1 FOREIGN KEY (p_u_id)
    REFERENCES u_userverwaltung (u_id)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION
);
...
CREATE TABLE IF NOT EXISTS t_termine (
  ...
  CONSTRAINT fk_t_termine_p_patient1 FOREIGN KEY (t_p_id)
    REFERENCES p_patient (p_id)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
...
CREATE TABLE IF NOT EXISTS sin_speech_in_noise_test (
  ...
  CONSTRAINT fk_sin_speech_in_noise_test_p_patient1 FOREIGN KEY (sin_p_id)
    REFERENCES p_patient (p_id)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION
);
...
CREATE TABLE IF NOT EXISTS e_ergebnisse (
  ...
  CONSTRAINT fk_e_ergebnisse_p_patient1 FOREIGN KEY (e_p_id)
    REFERENCES p_patient (p_id)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
...
CREATE TABLE IF NOT EXISTS pl_p_has_l (
  ...
  CONSTRAINT fk_p_patient_has_l_logging_p_patient1 FOREIGN KEY (pl_p_id)
    REFERENCES p_patient (p_id)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT fk_p_patient_has_l_logging_l_logging1 FOREIGN KEY (pl_l_id)
...
CREATE TABLE IF NOT EXISTS pb_p_hat_b (
  ...
  CONSTRAINT fk_p_patient_has_b_benachrichtigungen_p_patient1 FOREIGN KEY (pb_p_id)
    REFERENCES p_patient (p_id)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT fk_p_patient_has_b_benachrichtigungen_b_benachrichtigungen1 FOREIGN KEY (pb_b_id)
    REFERENCES b_benachrichtigungen (b_id)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION
);
...
CREATE TABLE IF NOT EXISTS sina_antwort (
  ...
  CONSTRAINT fk_sina_antwort_sinf_frage1 FOREIGN KEY (sina_sinf_id)
    ...
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT fk_sina_antwort_p_patient1 FOREIGN KEY (sina_p_id)
    REFERENCES p_patient (p_id)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION
);
